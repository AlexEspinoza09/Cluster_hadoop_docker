...
# 2. Formatear NameNode
Write-Host "2. Formateando NameNode..." -ForegroundColor Yellow
...
# 3. Iniciar SSH
Write-Host "3. Iniciando SSH en todos los nodos..." -ForegroundColor Yellow
...
# 4. Configurar SSH sin contraseña
Write-Host "4. Configurando SSH sin contraseña..." -ForegroundColor Yellow
...
# 5. Iniciar HDFS
Write-Host "5. Iniciando HDFS..." -ForegroundColor Yellow
docker exec -u hadoop hadoop-master bash -c "start-dfs.sh"
Start-Sleep -Seconds 10
Write-Host "   HDFS iniciado" -ForegroundColor Green
Write-Host ""

# 6. Crear directorios en HDFS
Write-Host "6. Creando directorios en HDFS..." -ForegroundColor Yellow
...
# 7. Iniciar YARN
Write-Host "7. Iniciando YARN..." -ForegroundColor Yellow
docker exec -u hadoop hadoop-master bash -c "start-yarn.sh" 2>$null
Start-Sleep -Seconds 5
Write-Host "   YARN iniciado" -ForegroundColor Green
Write-Host ""

# 8. Iniciar Job History Server
Write-Host "8. Iniciando Job History Server..." -ForegroundColor Yellow
